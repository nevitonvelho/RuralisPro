    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 print:block">
        ...
        <div className="lg:col-span-7 space-y-6 print:space-y-4">
           ...
           {/* Visual Tela */}
           <section className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm print:hidden relative overflow-hidden">
              ...
              <div className="bg-slate-50 rounded-xl p-4 border border-slate-200">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                      <button 
                        ...
                        className={`relative py-3 px-3 rounded-lg border text-left transition-all group ${
                            fatorGesso == 50 
