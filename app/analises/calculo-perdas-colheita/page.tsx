          ...
          <section className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm print:hidden">
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              <button
                ...
                className={`relative p-3 rounded-lg border text-left transition-all group flex items-center gap-3 ${cultura === 'soja'
              ...
              <button
                ...
                className={`relative p-3 rounded-lg border text-left transition-all group flex items-center gap-3 ${cultura === 'milho'
            ...
            <div className="bg-slate-50 p-1 rounded-lg flex mb-6 border border-slate-200">
              <button
                ...
                className={`flex-1 py-2 rounded-md text-xs font-bold transition-all flex items-center justify-center gap-2 ${metodo === 'contagem' ? 'bg-white text-emerald-700 shadow-sm border border-slate-200' : 'text-slate-400 hover:text-slate-600'
                  }`}
              >
              ...
              <button
                ...
                className={`flex-1 py-2 rounded-md text-xs font-bold transition-all flex items-center justify-center gap-2 ${metodo === 'pesagem' ? 'bg-white text-emerald-700 shadow-sm border border-slate-200' : 'text-slate-400 hover:text-slate-600'
                  }`}
              >
