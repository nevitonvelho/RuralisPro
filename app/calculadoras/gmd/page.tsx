...
export default function ConversaoAlimentarPage() {
  ...
  const resultados = useMemo(() => {
    ...
    if (nDias === 0) return { gmd: 0, ca: 0, custoArroba: 0, custoCabecaDia: 0, ganhoTotal: 0 };
    ...
    // 3. Conversão Alimentar (CA) = Consumo Total / Ganho Total
    // Ou simplificando: Consumo Diário / GMD
    ...
    // Custo por kg ganho = CA * Custo do kg da ração
    ...
    return {
        ...
        custoCabecaDia,
        custoArroba,
        eficiencia: ca > 0 ? (1 / ca) * 100 : 0 // Opcional: Eficiência Alimentar
    };
                 ...
                 <div className={`space-y-6 transition-all duration-500 ${!isAuthenticated ? 'opacity-40 pointer-events-none filter blur-sm select-none' : ''}`}>
                    ...
                    <div className="print-card bg-slate-900 text-white rounded-xl p-8 shadow-xl relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="w-full h-1.5 bg-slate-700 rounded-full overflow-hidden flex">
                                {/* Escala visual invertida: quanto menor melhor, mas para visualização, vamos preencher baseado num range de 4 a 12 */}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="print-card bg-white border border-slate-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
                             ...
                             <span className="text-3xl font-black text-slate-900 block">{fmtNum(resultados.gmd)}</span>
