...
export default function Home() {
  ...
  return (
    <div className="pb-20 bg-slate-50/50">
      ...
      {/* 4. GRID DE FERRAMENTAS */}
      <div id="analises" className="max-w-7xl mx-auto px-4 mt-8 scroll-mt-24">
              ...
              <div className="flex-1 px-2 pb-2">
                <div className="bg-slate-50/50 rounded-xl p-2 space-y-1">
                  {cat.calcs.map((calc, j) => {
                    const isPro = !['calagem', 'adubacao', 'gmd', 'taxa-lotacao', 'consumo-combustivel'].includes(calc.slug);
                    return (
                      <Link
                        key={j}
