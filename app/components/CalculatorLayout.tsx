    ...
    <>
      ...
      <style dangerouslySetInnerHTML={{
        ...
        @media print {
          ...
          /* Esconder elementos que não são de impressão se não estiverem no #print-area?
             Melhor confiar nas classes utilitárias no-print */
          ...
          /* Garantir que inputs pareçam texto normal */
          input { 
        ...
        <div className="hidden print:block mb-6 border-b border-slate-300 pb-4">
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center gap-5">
              {/* Logo adicionada conforme pedido */}
